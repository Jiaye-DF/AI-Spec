...
>
> **自動化**:本模板已包成 Claude Code skill(`/create-arch-diagram`),自動 cp bundle + 改名 + 衝突偵測。Skill 定義在 [`Harness-Engineering/Skills/create-arch-diagram/SKILL.md`](../../../Skills/create-arch-diagram/SKILL.md)。手動 cp 跟跑 skill 等價,選一即可。

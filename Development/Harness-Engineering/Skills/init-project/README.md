...
在空目錄產生 **React + TypeScript + FastAPI**(可選 PostgreSQL)專案最小可跑骨架的 Claude Code skill。本地開發優先,單純幫使用者起一個基本可跑環境,**不**內含 docs/Design-Base、CLAUDE.md、AGENTS.md 等 Harness-Engineering repo 的規範文件。
...
- **docs/Design-Base / docs/Arch / docs/Tasks** — 規範文件屬 Harness-Engineering repo,需要時由使用者另行引入
...
> 不再有 `docs/`、`CLAUDE.md`、`AGENTS.md`、`prompts/` — 那些是 Harness-Engineering repo 的內容,init-project 只是輕量 scaffold,不重複。

...
### ② 設計 Review Agent
- **觸發**:有新 PR 或新 Spec。
- **責任**:對照 [`spec/00-overview-v1.0.md`](../../Development/spec/00-overview-v1.0.md) 五大原則做 review。
...
- [`scan-project-v1.0.md`](../../Development/spec/scan-project-v1.0.md) — 設計 Review Agent 的規則庫雛形。
